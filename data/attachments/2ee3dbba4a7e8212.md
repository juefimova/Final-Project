...
Received string:    "Proszę wpisać poprawny adres e-mail lub nazwę użytkownika."
Timeout: 5000ms

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('[class*="Notification_label"]').first()
    13 × locator resolved to <div class="Notification_label__H9YdL">Proszę wpisać poprawny adres e-mail lub nazwę uży…</div>
       - unexpected value "Proszę wpisać poprawny adres e-mail lub nazwę użytkownika."

```

```yaml
- text: Proszę wpisać poprawny adres e-mail lub nazwę użytkownika.
```
